...
public class RequestContextServerInterceptor implements ServerInterceptor {
  ...
  /**
   * Add headers that our services would need internally or would need to propagate to downstream services, from the
   * metadata object into a RequestContext object.
   * object.
   *
   * @param metadata
   * @return
